<cfcomponent output="false">
    <cffunction name="getStates" access="remote" returntype="array">
        ...
        <cfloop query="states">
            ...
            <cfset results[count][1]="#LocationName#" />
            <cfset results[count][2]="#LocationName#" />
            <cfset count= count+1>
    ...
    <cffunction name="getCity" access="remote" returntype="array">
        <cfargument name="LocationName" type="any" required="true">
...
SELECT *
FROM ( SELECT [LocationName] FROM [test].[dbo].[MOC_Locations]
			where LocationName= '#arguments.LocationName# '
        ) A 
