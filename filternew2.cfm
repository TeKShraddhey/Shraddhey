...
<div style="clear:both; margin-top:10px;">
  ...
  <cfloop from="#variables.intMinLinkToShow#" to="#variables.intMaxLinkToShow-1#" index="i">
    <div style="float:left;font-weight:bold;margin:5px;padding:5px;border:1px solid black;">
      <cfoutput>
        <cfif intCurrentPage eq i>
         <a href="filternew.cfm"> < </a>
		
        <cfelse>
		  <a href="?PageIndex=#i#&selclassteacher=#RecordsPerPage#">#i+1#</a>
