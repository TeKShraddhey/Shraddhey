...
<form name="frm" action="resultfilter.cfm" method="post" autocomplete="on">
  ...
  Class:
   <select name= "class" id ="class">
	...
	<br>
    <input type="button" onClick="location.href='filter.cfm'" value='GO BACK TO FILTER'></td>
    <br>
...
AND JoiningDate  >= '<cfoutput>#dateformat(form.JoiningDate,"yyyy-mm-dd")#</cfoutput>'
</CFQUERY>



<cfquery NAME="in" DATASOURCE="test_1" dbtype="query" >
select *
from Info 
...
<th>firstname  <a href="S5.CFM">&#8595</th>
<th>lastname  <a href="S2.CFM">&#8595</th>
<th>joining date</th>
<th>telephone </th>
<th>email</th>
<th>class </th>
